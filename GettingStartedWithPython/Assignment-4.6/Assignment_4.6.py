#Write a program to prompt the user for hours and rate per hour using input to compute gross pay. Pay should be the normal rate for hours up to 40 
...
#and use the function to do the computation. The function should return a value. Use 45 hours and a rate of 10.50 per hour to test the program 
...
def computepay(hours, rate):
	if hours <= 40: 
		...
		pay = (regular_hours * rate) + (overtime_hours* overtime_rate)
	return pay
